...
function addExperiencia(divExper) {
    ...
    newdivEx.innerHTML += '<input type="text" class="form-control form-control-sm" name="Ncurso' + lineExper + '" id="iEmpresa' + lineExper + '" placeholder="empresa">';
    newdivEx.innerHTML += '<label for="iCargo' + lineExper + '" class="form-label text-muted">Cargo</label>';
    newdivEx.innerHTML += '<input type="text" class="form-control form-control-sm" name="Ncurso' + lineExper + '" id="iCargo' + lineExper + '" placeholder="cargo">';
